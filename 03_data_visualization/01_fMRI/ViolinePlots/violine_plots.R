...
# purpose: create violine plots to compare observed and expected correlations
# between ANT brain activation (1) and corresponding gene expression patterns (2) 

#set the wd to data folder
setwd("../../02_data/03_fMRI/")

# required packages: ggplot2, tidyr, data.table, yarrr
