...
# visualize ANT activation vectors (1),
# abagen gene expression matrix (2),
# and the gene expression correlation matrix of (1) with (2) 

# required packages: ggplot2, reshape2, RColorBrewer, ClusterR, cluster)
